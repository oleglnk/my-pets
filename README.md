...
This is my collection of pet projects. Below you can see general information about them.

|                Title                |                        Source Code                        |     Written in     |     License     | Year | Version |  Status   |
| ----------------------------------- |:---------------------------------------------------------:| ------------------ |:---------------:|:----:|:-------:|:---------:|
| *TBA*                               | -                                                         | -                  |        -        | 2023 |    -    |     -     |
| *TBA*                               | -                                                         | -                  |        -        | 2023 |    -    |     -     |
...
| [Tetris](#tetris)                   | Lost                                                      | C++                |       MIT       | 2021 |   1.0   |  Archive  |
| [Battleship game](#battleship-game) | [Source Code](https://gitlab.com/oleglnk/battleship-game) | C++                |       MIT       | 2019 |   1.0   |  Archive  |
| [Fractals](#fractals)               | [Source Code](https://gitlab.com/oleglnk/fractals)        | C++, MFC           |       MIT       | 2016 |   1.0   |  Archive  |
| [Audio Editors](#audio-editors)     | [Source Code](https://gitlab.com/oleglnk/audio-editors)   | C++, MFC, BASS.dll |       MIT       | 2016 |   1.0   |  Archive  |

Status:
- Active - in active development
- Suspended - there are some features/changes which can/should be added, but they aren't urgent
- Support - everything was implemented, project is no longer maintained, but it will be opened for issues for sometime
